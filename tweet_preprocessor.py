...
class TWPreprocessor:
    ...
    def preprocess(cls, tweet,country):
        ...
        cleaned_text = _text_cleaner(tweet.full_text)[0]
        ...
        preprocess_tweet['tweet_emoticons'] = _text_cleaner(tweet.full_text)[1]
        preprocess_tweet['tweet_text'] = tweet.full_text
